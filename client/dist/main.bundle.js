...
module.exports = "\n<h1>Anonymous Notes</h1>\n\n<app-create></app-create>\n\n<div class=row *ngFor=\"let note of list.reverse()\">\n    <div class=col-sm-12>\n        {{note.date|date:'medium'}}<br>\n        {{note.text}}\n        <hr>\n    </div>\n</div>"
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.getNotes = function () {
        var _this = this;
        this._ns.list().subscribe(function (list) { return _this.list = list; });
    };
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__notes_service__["a" /* NotesService */]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__notes_service__ = __webpack_require__("../../../../../src/app/notes.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_6__notes_service__["a" /* NotesService */]],
...
module.exports = "\n<div>\n  <form (submit)=\"create()\">\n  Note: <input type=text name=text [(ngModel)]='note.text' #text='ngModel' required minlength=3>\n  <input type=submit value=Add>\n  </form>\n</div>"
...
var CreateComponent = (function () {
    function CreateComponent(_ns, _app) {
        this._ns = _ns;
        this._app = _app;
    ...
    CreateComponent.prototype.create = function () {
        ...
        this._ns.create(this.note).subscribe(function (list) { return _this._app.list = list; });
        this.note = { text: '', date: null };
    };
    CreateComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__notes_service__["a" /* NotesService */], __WEBPACK_IMPORTED_MODULE_2__app_component__["a" /* AppComponent */]])
    ], CreateComponent);
...
var NotesService = (function () {
    ...
    NotesService.prototype.list = function () {
